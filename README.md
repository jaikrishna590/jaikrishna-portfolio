...
<head>
    ...
    <title>Jai krishna R - Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <header>
        ...
        <img src="Phone/DCIM/Camera/IMG20250404125300.jpg" alt="Jai Krishna R" class="profile-picture">
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="mailto:rockyjoe0823@gmail.com">rockyjoe0823@gmail.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 Jai krishna R. All Rights Reserved.</p>
    </footer>
